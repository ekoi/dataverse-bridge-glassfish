...
import nl.knaw.dans.dataverse.bridge.converter.DdiParser;
import nl.knaw.dans.dataverse.bridge.converter.DvnFile;
import nl.knaw.dans.dataverse.bridge.converter.FilesXmlCreator;
import nl.knaw.dans.dataverse.bridge.db.*;
import nl.knaw.dans.dataverse.bridge.easy.DvnBridgeDataset;
import nl.knaw.dans.dataverse.bridge.easy.IngestToEasy;
import nl.knaw.dans.dataverse.bridge.easy.XsltDvn2EasyTransformer;
...
//    @EJB
    ...
    public DataverseBridgeHandler(){
        datafileService = new DatafileServiceBean();
